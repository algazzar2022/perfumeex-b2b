              ...
              <div className="flex-1 space-y-4">
                ...
                <div>
                  <input 
                    ...
                    value={data.story?.image?.startsWith('http') ? data.story.image : ''} 
                    onChange={e => updateStory('image', e.target.value)} 
                    className="w-full bg-[#0a0a0a] border border-white/10 rounded-lg px-4 py-2 focus:border-emerald-500 outline-none" 
                    dir="ltr" 
                  />
                  <p className="text-sm text-gray-500 mt-2">وضع رابط خارجي للصورة مباشرة</p>
                </div>
              </div>
            </div>
          </div>
