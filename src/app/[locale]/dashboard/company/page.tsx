              ...
              <div className="bg-zinc-950 border border-white/5 p-8 rounded-3xl">
                ...
                <div className="space-y-5">
                  ...
                  <div className="border-b border-white/5 pb-8 mb-8">
                    <h3 className="text-lg font-bold text-white mb-5">{t("general.locationTitle") || (isAr ? "الموقع الجغرافي" : "Geographic Location")}</h3>
                    ...
                    <div className="space-y-4">
                      {formData.countryAr && !ARAB_COUNTRIES.find(c => c.nameAr === formData.countryAr && c.id !== "OTHER") && (
                        <div className="bg-emerald-900/10 border border-emerald-500/20 p-5 rounded-2xl grid grid-cols-1 md:grid-cols-2 gap-5">
                          <div>
                            <label className="block text-sm font-medium text-emerald-400 mb-2">{isAr ? "اكتب اسم الدولة (بالإنجليزية)" : "Write Country Name (English)"}</label>
                          ...
                          <div>
                            <label className="block text-sm font-medium text-emerald-400 mb-2">{isAr ? "اكتب اسم الدولة (بالعربية)" : "Write Country Name (Arabic)"}</label>
                      ...
                      {(() => {
                        ...
                        return (
                          <div className="bg-emerald-900/10 border border-emerald-500/20 p-5 rounded-2xl grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div>
                              <label className="block text-sm font-medium text-emerald-400 mb-2">{isAr ? "اكتب اسم المحافظة (بالإنجليزية)" : "Write Governorate Name (English)"}</label>
                            ...
                            <div>
                              <label className="block text-sm font-medium text-emerald-400 mb-2">{isAr ? "اكتب اسم المحافظة (بالعربية)" : "Write Governorate Name (Arabic)"}</label>
                      ...
                      {(() => {
                        ...
                        return (
                          <div className="bg-emerald-900/10 border border-emerald-500/20 p-5 rounded-2xl grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div>
                              <label className="block text-sm font-medium text-emerald-400 mb-2">{isAr ? "اكتب اسم المدينة (بالإنجليزية)" : "Write City Name (English)"}</label>
                            ...
                            <div>
                              <label className="block text-sm font-medium text-emerald-400 mb-2">{isAr ? "اكتب اسم المدينة (بالعربية)" : "Write City Name (Arabic)"}</label>
            ...
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
              <div className="bg-zinc-950 border border-white/5 p-8 rounded-3xl">
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-zinc-400 mb-2">{t("contact.facebook") || "Facebook"}</label>
                    <div className="relative">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-zinc-400 mb-2">{t("contact.instagram") || "Instagram"}</label>
                    <div className="relative">
                      <div className="absolute top-3.5 ltr:left-4 rtl:right-4 text-emerald-500">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-zinc-400 mb-2">{t("contact.twitter") || "X (Twitter)"}</label>
                    <div className="relative">
                      <div className="absolute top-3.5 ltr:left-4 rtl:right-4 text-emerald-500">
